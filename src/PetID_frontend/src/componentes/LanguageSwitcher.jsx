...
const LanguageSwitcher = () => {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        className="flex items-center gap-1 py-1 px-2 rounded-md hover:bg-gray-100 dark:hover:bg-slate-700 transition-colors text-gray-700 dark:text-slate-200"
      ...
      {isOpen && (
        <div className="absolute right-0 mt-1 w-40 bg-white dark:bg-slate-800 rounded-md shadow-lg z-50 border border-gray-100 dark:border-slate-700">
          <ul className="py-1">
            <li>
              <button
