...
const MedicalPanel = () => {
  ...
  const { healthRecords, addHealthRecord, clearHealthRecords } = useAuth(); // Adicionar função de limpeza
  ...
  const handleNewRecord = () => {
    setShowForm(false); // Apenas fechar o formulário, o registro já foi adicionado
  };
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div className="flex items-center space-x-4">
          ...
          {/* Botão temporário para limpar registros duplicados */}
          <button
            onClick={clearHealthRecords}
