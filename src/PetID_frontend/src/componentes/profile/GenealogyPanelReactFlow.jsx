...
const PetNode = ({ data, selected }) => {
  const { pet, onEdit, onConnect, onDelete, isConnecting, connectionStart } = data;
        ...
        <div className="flex items-center justify-between mb-2">
          ...
          <div className="flex space-x-2">
            ...
            <button
              ...
              `}
              title={isConnecting ? "Conectar" : "Criar Parentesco"}
            >
...
const GenealogyPanel = () => {
  ...
  const createConnection = (relationshipType) => {
    ...
    const edgeStyle = getEdgeStyle(relationshipType);
    const newEdge = {
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-600 dark:text-slate-300 mb-4">
                    {pets.length === 0 
                      ...
                      : "Todos os seus pets já estão no canvas."
                    }
                  </p>
                  <button
                    onClick={() => setShowPetSelector(false)}
                ...
                <div>
                  <div className="mb-4 p-3 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
                    <p className="text-sm text-blue-800 dark:text-blue-200 text-center">
                      🎯 <strong>{availablePets.length} pet(s)</strong> disponível(is) para adicionar à árvore genealógica
                    </p>
                  </div>
