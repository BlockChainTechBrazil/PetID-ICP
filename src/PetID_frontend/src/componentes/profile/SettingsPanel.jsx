...
const SettingsPanel = () => {
  ...
  return (
    <form onSubmit={save} className="flex flex-col gap-5">
      <section className="rounded-2xl border border-gray-200 dark:border-surface-100 bg-white/70 dark:bg-surface-75/70 backdrop-blur p-5 space-y-4">
        <div className="flex items-start justify-between flex-wrap gap-3">
          <div>
            <h2 className="text-base md:text-lg font-semibold text-gray-800 dark:text-white flex items-center gap-2">⚙️ {t('profile.settings.title')}</h2>
            <p className="text-[11px] md:text-xs text-gray-500 dark:text-slate-400 mt-1 max-w-xl">{t('profile.settings.apiKeyHint')}</p>
          </div>
          <button type="submit" disabled={saving} className="px-4 py-2 rounded-xl text-xs md:text-sm font-semibold bg-gradient-to-r from-brand-500 to-petPurple-500 text-white shadow hover:shadow-md disabled:opacity-60 disabled:cursor-not-allowed flex items-center gap-2 order-first md:order-none">
        ...
        <div className="grid lg:grid-cols-3 gap-5">
          <div className="rounded-xl border border-gray-200 dark:border-surface-100 bg-white/80 dark:bg-surface-75/80 p-4 space-y-4">
          ...
          <div className="rounded-xl border border-gray-200 dark:border-surface-100 bg-white/80 dark:bg-surface-75/80 p-4 space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-[11px] md:text-sm">
