...
const NFTPetsPanel = () => {
  ...
  // ✅ MIGRAÇÃO: Upload para ICP ao invés de IPFS
  const uploadToICP = async (file) => {
    ...
    setUploadProgress('Uploading to ICP...');
  ...
  // ✅ Função auxiliar para obter URL da imagem ICP para uso em HTML estático
