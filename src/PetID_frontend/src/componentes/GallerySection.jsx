    ...
    <section className="py-24 bg-gradient-to-b from-blue-50 via-white to-white dark:from-surface-75 dark:via-surface-100 dark:to-slate-900 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
          {images.map((src, i) => (
            <div key={i} className={`relative overflow-hidden rounded-2xl shadow-md aspect-[4/5] group reveal delay-${(i + 1) * 50} bg-white dark:bg-gradient-to-br dark:from-surface-100 dark:via-surface-75 dark:to-surface-100`}>
              {!loaded[i] && (
