...
const baseDogs = {
  hero: [
    ...
    { src: 'https://images.unsplash.com/photo-1518717758536-85ae29035b6d?auto=format&fit=crop&w=500&q=70', speed: 0.16, className: 'w-32 md:w-40 bottom-[40px] left-[55%] rotate-[3deg]' }
  ]
};
